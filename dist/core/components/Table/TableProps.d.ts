...
export interface TableProps<T> {
     ...
     * @param sortBy
     */
    checkFilterCombination?: (filterValues: TableFilterValues<T>, sortBy?: [string, "asc" | "desc"]) => boolean;
    /**
 ...
 * @category Components
 */
export declare type TableColumnFilter = {
 ...
 */
export declare type OnTableColumnResizeParams<T> = {
    width: number;
    key: string;
    column: TableColumn<T>;
};
 ...
 * @category Components
 */
export declare type TableSize = "xs" | "s" | "m" | "l" | "xl";
/**
 * @see Table
 * @category Components
 */
export declare type TableEnumValues = Record<string | number, string> | Map<string | number, string>;
/**
 * @see Table
 * @category Components
 */
export declare type TableSort = "asc" | "desc" | undefined;
/**
 * @see Table
 * @category Components
 */
export declare type TableFilterValues<M> = {
    [K in keyof M]?: [TableWhereFilterOp, any];
};
/**
 ...
 * @category Models
 */
export declare type TableWhereFilterOp = "<" | "<=" | "==" | "!=" | ">=" | ">" | "array-contains" | "in" | "array-contains-any";
