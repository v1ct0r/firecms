 ...
 * @category Models
 */
export declare type NavigationBuilder<UserType extends User = User> = ((props: NavigationBuilderProps<UserType>) => Promise<Navigation>) | ((props: NavigationBuilderProps<UserType>) => Navigation);
/**
 * @category Models
 */
