 ...
 */
export interface FieldProps<T extends CMSType, CustomProps = any, M extends {
    [Key: string]: any;
} = any> {
    /**
 ...
 * @category Form custom fields
 */
export interface FormContext<M extends {
    [Key: string]: any;
}> {
    /**
 ...
 * @category Form custom fields
 */
export interface CMSFormFieldProps<M extends {
    [Key: string]: any;
} = any> {
    /**
     ...
     */
    property: StringProperty | NumberProperty | BooleanProperty | TimestampProperty | GeopointProperty | ReferenceProperty | ArrayProperty | MapProperty;
    /**
