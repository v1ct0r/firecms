 ...
 * @category Models
 */
export declare type PartialProperties<M> = Record<keyof M, Partial<AnyProperty>>;
/**
 * Use to resolve the schema properties for specific path, entity id or values.
 * @category Models
 */
export declare type PartialEntitySchema<M> = Omit<Partial<EntitySchema<M>>, "properties"> & {
