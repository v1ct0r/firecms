 ...
 */
export declare type CMSType = string | number | boolean | Date | GeoPoint | EntityReference | {
    [Key: string]: any;
} | CMSType[];
/**
 * @ignore
 */
export declare type AnyProperty = StringProperty | NumberProperty | BooleanProperty | TimestampProperty | GeopointProperty | ReferenceProperty | ArrayProperty | MapProperty;
/**
 * @category Entity properties
 */
export declare type Property<T extends CMSType = CMSType> = T extends string ? StringProperty : T extends number ? NumberProperty : T extends boolean ? BooleanProperty : T extends Date ? TimestampProperty : T extends GeoPoint ? GeopointProperty : T extends EntityReference ? ReferenceProperty : T extends Array<CMSType> ? ArrayProperty<T> : T extends {
    [Key: string]: any;
} ? MapProperty<T> : AnyProperty;
/**
 * @category Entity properties
 */
export declare type DataType = "number" | "string" | "boolean" | "map" | "array" | "timestamp" | "geopoint" | "reference";
/**
 * @category Entity properties
 */
export declare type MediaType = "image" | "video" | "audio";
/**
 ...
 * @category Entity properties
 */
export declare type EnumType = number | string;
/**
 ...
 * @category Entity properties
 */
export declare type EnumValues = Record<string | number, string | EnumValueConfig> | Map<string | number, string | EnumValueConfig>;
/**
 ...
 * @category Entity properties
 */
export declare type Properties<M extends {
    [Key: string]: any;
} = any> = {
 ...
 * @category Entity properties
 */
export declare type PropertiesOrBuilder<M extends {
    [Key: string]: any;
}> = {
 ...
 * @category Entity properties
 */
export interface MapProperty<T extends {
    [Key: string]: any;
} = any> extends BaseProperty {
    dataType: "map";
    /**
     * Record of properties included in this map.
     */
    properties?: Properties<Partial<T>>;
    /**
     * Rules for validating this property
     */
    validation?: PropertyValidationSchema;
 ...
 * @category Entity properties
 */
export interface ReferenceProperty<M extends {
    [Key: string]: any;
} = any> extends BaseProperty {
    dataType: "reference";
    /**
 ...
 * @category Entity properties
 */
export declare type StorageFileTypes = "image/*" | "video/*" | "audio/*" | "application/*" | "text/*" | "font/*" | string;
/**
 * @category Entity properties
 */
