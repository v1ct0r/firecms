 ...
 * @category Models
 */
export interface EntitySchema<M extends {
    [Key: string]: any;
} = any> {
    /**
 ...
 * @category Models
 */
export declare type EntityStatus = "new" | "existing" | "copy";
/**
 * Representation of an entity fetched from the datasource
 * @category Models
 */
export interface Entity<M extends {
    [Key: string]: any;
}> {
    /**
     * Id of the entity
 ...
 * @category Models
 */
export declare type EntityValues<M> = M;
/**
 ...
 * @ignore
 */
export declare type InferSchemaType<S extends EntitySchema> = S extends EntitySchema<infer M> ? M : never;
/**
 ...
 * @category Models
 */
export interface EntityCustomViewParams<M extends {
    [Key: string]: any;
} = any> {
    /**
