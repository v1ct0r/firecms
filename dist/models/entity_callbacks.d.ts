import { Entity, EntityStatus, EntityValues, ResolvedEntitySchema } from "./entities";
 ...
 * @category Models
 */
export interface EntityCallbacks<M extends {
    [Key: string]: any;
} = any> {
    /**
     ...
     */
    onSaveSuccess?(entitySaveProps: EntityOnSaveProps<M>): Promise<void> | void;
    /**
     * Callback used when saving fails
     * @param entitySaveProps
     */
    onSaveFailure?(entitySaveProps: EntityOnSaveProps<M>): Promise<void> | void;
    /**
     ...
     * @param entitySaveProps
     */
    onPreSave?(entitySaveProps: EntityOnSaveProps<M>): Promise<Partial<EntityValues<M>>> | Partial<EntityValues<M>>;
    /**
 ...
 * @category Models
 */
export interface EntityOnSaveProps<M extends {
    [Key: string]: any;
}> {
    /**
 ...
 * @category Models
 */
export interface EntityOnDeleteProps<M extends {
    [Key: string]: any;
}> {
    /**
